...
function defaultError(err: unknown): Response { console.error('[satellite-tracker]', err); return new Response(JSON.stringify({ error: 'internal' }), { status: 500, headers: { 'content-type': 'application/json' } }); }
