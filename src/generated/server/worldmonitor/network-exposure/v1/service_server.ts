...
function defaultError(err: unknown, _req?: Request): Response { console.error('[network-exposure]', err); return new Response(JSON.stringify({ error: 'internal' }), { status: 500, headers: { 'content-type': 'application/json' } }); }
