...
function defaultError(err: unknown): Response { console.error('[telegram]', err); return new Response(JSON.stringify({ error: 'internal' }), { status: 500, headers: { 'content-type': 'application/json' } }); }
